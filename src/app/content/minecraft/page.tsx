        ...
        <div className="container-hkust mx-auto max-w-5xl space-y-20">
          ...
          >
            ...
            >
              ...
              <img
                src="/hkust-minecraft-topdown-v1.7.png"
                alt="HKUST in Minecraft v1.7 — annotated top-down with 12/12 real HKUST landmarks, including 浑天仪 (Armillary Sphere), Shaw Auditorium, Marine Lab, and RED 火鸟 Sundial"
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              <a
                href="https://github.com/clarkwei-101/hkust-minecraft/releases/tag/v1.7"
                target="_blank"
