        ...
        <div className="container-hkust mx-auto max-w-5xl space-y-20">
          ...
          >
            ...
            >
              ...
              <img
                src="/hkust-minecraft-topdown-v1.4-detailed.png"
                alt="HKUST in Minecraft v1.4-detailed — annotated top-down map with 22 features (8 landmarks + 14 enhanced buildings with windows, dome, doors) plus paths, roads, parking, trees, and sports fields"
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <a
                href="/hkust-minecraft-world/HKUST-2026-Bedrock-v1.4-detailed.mcworld"
                download
              ...
              <a
                href="https://github.com/clarkwei-101/hkust-minecraft/releases/tag/v1.4-detailed"
                target="_blank"
